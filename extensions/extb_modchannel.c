/*
 * Moderation channel extban type: matches users who are in a certain private channel
 * -- Niichan
 *
 */
...
static int eb_modchannel(const char *data, struct Client *client_p, struct Channel *chptr, long mode_type);
...
static int eb_modchannel(const char *data, struct Client *client_p,
